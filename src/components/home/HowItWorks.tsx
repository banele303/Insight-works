...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-28 bg-[#050a18] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-gray-400 max-w-xl mx-auto text-lg">
            From onboarding to fully operational — Glenanda Shopping Learning Center gets your school
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-16 left-[12.5%] right-[12.5%] h-px bg-gradient-to-r from-transparent via-[#f97316]/30 to-transparent z-0" />
            ...
            {steps.map((step, idx) => (
              <div key={idx} className="flex flex-col items-center text-center group">
                ...
                >
                  ...
                  {/* Step number badge */}
                  <span className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-white/[0.03] border border-white/[0.08] text-xs font-black text-white flex items-center justify-center shadow-md">
                    {step.number}
                  </span>
                </div>
        ...
        {/* Bottom CTA strip */}
        <div className="mt-20 bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Join a growing community of home schooling families across South Africa.
            </p>
          </div>
          <div className="flex gap-3 shrink-0">
            <a
              href="/login"
              className="bg-[#f97316] text-black px-7 py-3 rounded-xl font-bold hover:bg-[#ea580c] transition-all hover:scale-105 shadow-lg shadow-[#f97316]/20"
            >
              Apply for Enrolment
            </a>
            <a
              href="/contact"
              className="border border-white/[0.08] text-gray-300 px-7 py-3 rounded-xl font-bold hover:border-[#f97316] hover:text-[#f97316] transition-all"
            >
              Book a Demo
            </a>
          </div>
