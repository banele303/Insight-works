...
export default function TraumaRecoveryPage() {
  const benefits = [
    {
      ...
      desc: "Release fight-or-flight energy stored in the physical body using gentle somatic experiencing and vagus nerve toning protocols."
    },
    {
      title: "Processing Complex Grief & Loss",
      desc: "Provide gentle, unhurried space to integrate profound bereavement, life transitions, and unprocessed emotional wounds."
    },
    {
      title: "Desensitizing Intrusive Triggers & Flashbacks",
      desc: "Evidence-based cognitive and mindfulness modalities to safely disarm traumatic memories without retraumatization."
    },
    {
      title: "Inner Child & Attachment Wound Healing",
      desc: "Reclaim emotional safety, repair developmental rupture, and establish compassionate self-parenting foundations."
    }
  ];
  ...
  const processSteps = [
    {
      step: "01",
      title: "Stabilization & Safety First",
      desc: "We establish grounding anchors and internal safety resources before exploring any sensitive trauma material."
    },
    {
      step: "02",
      title: "Paced Memory Processing",
      desc: "Gentle, titrated exploration of past events ensuring your nervous system remains grounded throughout."
    },
    {
      step: "03",
      title: "Somatic Release & Integration",
      desc: "Releasing trapped emotional distress from the body through breathwork, mindfulness, and sensory regulation."
    },
    {
      step: "04",
      title: "Post-Traumatic Growth & Wholeness",
      desc: "Reclaim agency, deepen self-worth, and rebuild a fulfilling present grounded in peace and autonomy."
    }
  ];
  ...
  const faqs = [
    {
      ...
      a: "No. Trauma recovery does not require reliving painful memories in overwhelming detail. We work at your own pace with a strong emphasis on somatic safety."
    },
    {
      q: "How many sessions are recommended for trauma healing?",
      a: "Trauma healing is deeply individualized. Typically, 8–12 sessions allow for thorough stabilization, safe processing, and post-traumatic integration."
    },
    {
      q: "Is somatic therapy suitable for PTSD and chronic anxiety?",
      a: "Yes. Somatic experiencing is recognized as one of the most effective approaches for resetting a dysregulated nervous system."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white text-[#0f2820]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <main className="pt-28 sm:pt-32 pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 items-center">
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 px-3.5 py-1.5 rounded-full">
                <Sparkles className="w-4 h-4 text-[#ea7627]" />
              ...
              >
                ...
                <span
                  style={{
                    background: "linear-gradient(135deg, #ea7627 0%, #156e52 100%)",
              ...
              <p className="text-slate-600 text-base sm:text-lg leading-relaxed max-w-xl">
                A gentle, somatic-informed sanctuary to release past pain, regulate a hypervigilant nervous system, and reclaim your peace of mind.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 py-2 text-sm text-slate-700">
                <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 px-4 py-2 rounded-xl font-bold">
                  <Clock className="w-4 h-4 text-[#ea7627]" /> 60 Minutes
                </div>
                <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 px-4 py-2 rounded-xl font-bold text-[#ea7627]">
                  <span>R750 – R950</span> per session
                </div>
                <div className="flex items-center gap-2 text-xs text-slate-500 font-medium">
                  <Shield className="w-3.5 h-3.5 text-emerald-600" /> Trauma-Informed Certified
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 pt-2">
                <Link
                  to="/booking"
                  className="bg-gradient-to-r from-[#ea7627] to-[#156e52] hover:opacity-95 text-white px-7 py-3.5 rounded-xl font-bold text-sm text-center shadow-md shadow-amber-900/15 flex items-center justify-center gap-2 transition-all hover:scale-102 cursor-pointer"
                >
                  Book Trauma Consultation <ArrowRight className="w-4 h-4" />
                </Link>
                <Link
                  to="/intake"
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-slate-200/80 group">
                <img
                  src="/images/services/trauma-recovery.jpg"
                  alt="Trauma Recovery Session"
                ...
                <div className="absolute bottom-5 left-5 right-5 text-white space-y-1">
                  <p className="text-xs font-bold uppercase tracking-wider text-amber-300">Somatic &amp; Nervous System Care</p>
                  <p className="text-sm font-semibold">Gentle Pacing · Complete Psychological Safety</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* ── FOCUS AREAS ── */}
        <section className="bg-amber-50/20 border-y border-amber-200/60 py-16 sm:py-20 mb-20">
        ...
        <section className="container mx-auto px-4 max-w-5xl">
          <div className="bg-gradient-to-br from-[#120f0a] via-[#ea7627] to-[#156e52] rounded-3xl p-8 sm:p-12 text-white text-center space-y-5 shadow-xl">
            ...
            <p className="text-amber-100 text-sm sm:text-base max-w-lg mx-auto leading-relaxed">
              Book a safe, gentle trauma recovery consultation with Maletsatsi Sibanda.
            </p>
