          ...
          <div className="w-full max-w-sm space-y-6">
            ...
            <div className="flex flex-col gap-2 text-center">
              <h1 className="text-2xl font-semibold tracking-tight">
                {mode === "login" ? "Welcome back" : "Join Glenanda Shopping Learning Center"}
              </h1>
            ...
            <div className="text-center text-sm">
              {mode === "login" ? (
                <>
                  New to Glenanda Shopping Learning Center?{" "}
                  <button
      ...
      <div className="relative hidden lg:block">
        ...
        <div className="absolute bottom-12 left-10 right-10 text-white">
          ...
          <p className="text-gray-200 text-sm max-w-sm">
            From Grade R to Matric, Glenanda Shopping Learning Center helps schools manage learners, timetables,
