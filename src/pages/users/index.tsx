...
export default function UserManagementPage({
  ...
  return (
    <div className="p-4 md:p-8 space-y-6 bg-slate-50 dark:bg-slate-950 min-h-screen text-[#0f2820] dark:text-slate-100" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      {/* Header */}
      ...
      {/* Filter & Toolbar Row */}
      <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xs">
        <div className="flex flex-wrap items-center gap-3 flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Select value={statusFilter} onValueChange={setStatusFilter}>
              <SelectTrigger className="w-[180px] text-xs font-medium bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200 rounded-xl border-slate-200">
          ...
          {role === "student" && (
            <Select value={disciplineFilter} onValueChange={setDisciplineFilter}>
              <SelectTrigger className="w-[190px] text-xs font-medium bg-slate-50 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200 rounded-xl border-slate-200">
        ...
        <div className="flex items-center justify-between lg:justify-end gap-3 text-xs text-slate-500 dark:text-slate-400">
          {convexUsers && (
            <Badge variant="secondary" className="font-bold text-xs px-2.5 py-1 bg-emerald-50 dark:bg-emerald-950/40 text-[#156e52] dark:text-emerald-400 border border-emerald-200/60 dark:border-emerald-800">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <SelectTrigger className="w-[70px] h-8 text-xs rounded-lg dark:bg-slate-800 dark:border-slate-700">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
