...
const Timetable = () => {
  ...
  const [selectedClass, setSelectedClass] = useState(() => {
    if (typeof window !== "undefined") {
      return localStorage.getItem("Glenanda Shopping Learning Center_selected_timetable_class") || "";
    }
    return "";
  });
  ...
  const handleClassSelect = (val: string) => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("Glenanda Shopping Learning Center_selected_timetable_class", val);
    }
  };
