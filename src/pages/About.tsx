...
const About = () => {
  ...
  const values = [
    ...
    { icon: Zap, title: "Offline-First", desc: "Built for the South African reality — our learning system works even on low-bandwidth connections." },
  ...
  return (
    <div>
      ...
      <main>
        {/* Hero */}
        <section className="relative pt-32 pb-24 bg-gradient-to-b from-[#f97316]/10 to-background overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#f97316]/10 rounded-full blur-[120px]" />
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              <div className="inline-block bg-[#f97316]/10 text-[#f97316] text-sm font-bold px-4 py-1.5 rounded-full mb-6 uppercase tracking-wider">
                About Glenanda Shopping Learning Center
              </div>
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Empowering South African Schools Since 2017
              </h1>
              <p className="text-xl text-gray-400 leading-relaxed">
                Glenanda Shopping Learning Center was born from a simple observation: South African educators spend
                60% of their time on administration instead of teaching. We're changing that
                — with a learning system built specifically for the South African education landscape.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-6">
                  From our home in Glenanda, Johannesburg, Glenanda Shopping Learning Center
                  serves over 200 schools across all nine provinces, managing more than 150,000
                  learner records.
                </p>
                <div className="flex gap-8">
                  <div>
                    <p className="text-4xl font-bold text-[#f97316]">200+</p>
                    <p className="text-sm text-gray-500">Schools</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-[#f97316]">150K</p>
                    <p className="text-sm text-gray-500">Learners</p>
                  </div>
                  <div>
                    <p className="text-4xl font-bold text-[#f97316]">9</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                {values.map(({ icon: Icon, title, desc }) => (
                  <div key={title} className="bg-gray-50 dark:bg-[#1c1c1c] rounded-2xl p-6 border border-white/[0.08]">
                    <div className="bg-[#f97316]/10 w-12 h-12 rounded-xl flex items-center justify-center mb-4">
              ...
              {team.map((member) => (
                <div key={member.name} className="text-center">
                  <img
                    src={member.img}
                    alt={member.name}
                    className="w-28 h-28 rounded-full mx-auto mb-4 object-cover border-4 border-[#f97316]/20"
                  />
        ...
        <section className="py-20 bg-gray-50 dark:bg-[#1c1c1c]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Ready to join the Glenanda Shopping Learning Center family?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/login"
                className="bg-[#f97316] text-black px-8 py-4 rounded-xl font-bold text-lg hover:bg-[#ea580c] transition-all"
              >
                Get Started Free
              </Link>
              <Link
                to="/contact"
                className="border border-gray-300 dark:border-gray-700 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
              >
                Contact Sales
              </Link>
            </div>
