...
export default defineSchema({
  ...
  applications: defineTable({
    ...
    gradeApplyingFor: v.number(),          // Grade R (0) to 12
    schoolPhase: v.string(),               // Foundation / Intermediate / Senior / FET / Pre-school
    ...
    previousSchoolReport: v.optional(v.string()), // storage URL or notes
    ...
    createdAt: v.number(),
    updatedAt: v.optional(v.number()),
    // Optional reference number e.g. GSLC-2026-0001
    applicationNumber: v.optional(v.string()),
    // If accepted and learner account created
    linkedStudent: v.optional(v.id("users")),
  }).index("by_status", ["status"])
